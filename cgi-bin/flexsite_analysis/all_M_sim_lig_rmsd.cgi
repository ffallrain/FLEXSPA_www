...
open AF,"/flexsite/www/html/flexsite/all_0-35_0_4.5_allatom_chains_0.95-0.7_residue";
@pair=<AF>;
close AF;
open LIG,"/flexsite/www/html/flexsite/all_0-35_sim0.95-0.7_0_4.5_format";
@lig=<LIG>;
close LIG;
for my $line (@lig)
{
...
print  header;
print  start_html( -title => "Binding site conformational change upon binding not very similar ligands" );
