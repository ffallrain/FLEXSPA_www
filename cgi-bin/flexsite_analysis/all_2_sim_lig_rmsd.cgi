...
open AF,"/flexsite/www/html/flexsite/all_0-35_0_4.5_allatom_chains_0.95_residue";
#open AF,"aa";
@pair=<AF>;
close AF;
open LIG,"/flexsite/www/html/flexsite/all_0-35_sim0.95_0_4.5_format";
@lig=<LIG>;
close LIG;
for my $line (@lig)
{
...
print  header;
print  start_html( -title => "Binding site conformational change upon binding similar ligands" );
